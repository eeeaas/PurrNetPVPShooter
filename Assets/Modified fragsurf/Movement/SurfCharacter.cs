...
namespace Fragsurf.Movement {
    ...
    public class SurfCharacter : MonoBehaviour, ISurfControllable {
        ...
        private void Start () {
            ...
            _colliderObject.layer = LayerMask.NameToLayer ("Ignore Raycast");
        ...
        private void UpdateMoveData () {
            ...
            vert = _moveData.verticalAxis;
            horiz = _moveData.horizontalAxis;
            Vector3 moveDirection = transform.right * _moveData.horizontalAxis + transform.forward * _moveData.verticalAxis ;
            ...
            bool scrolled = Mathf.Abs(scroll) > 0.01f;

            bool jumpPressed = Input.GetButtonDown("Jump") || scrolled;

            bool jumpHeld = Input.GetButton("Jump") || scrolled;
